...
#include "mllm/Utils/Metrics.hpp"
#include <iostream>
#include <vector>
#include <cstring>
#include <unistd.h>
...
int main(int argc, char** argv) {
  ...
  json_result["sample_interval"] = sample_interval;
  json_result["samples"] = samples;
  json_result["total_energy"] = total_energy;
  json_result["average_power"] = average_power;
  ...
  output_file << json_result.dump(4);  // Pretty print with indentation of 4 spaces
  output_file.close();
