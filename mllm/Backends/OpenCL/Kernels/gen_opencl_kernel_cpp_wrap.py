...
def gen_opencl_kernel_cpp_wrap() -> None:
...
def gen_opencl_kernel_cpp_wrap_core() -> None:
    def core_template() -> str:
        return f"""// This file is generated by gen_opencl_kernel_cpp_wrap.py
...
if __name__ == "__main__":
    gen_opencl_kernel_cpp_wrap()
    gen_opencl_kernel_cpp_wrap_core()
