...
size_t KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::workspace_size(
  ...
  switch (lhs_dtype) {
    ...
    default: MLLM_ERROR_EXIT(kError, "Unsupported lhs_dtype");
  }
}

size_t KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::quant_pack_rhs_size(
    int N, int K, KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::Tiles tile_cfg) {
  const size_t nr = ukernels_[tile_cfg].get_nr();
  const size_t kr = ukernels_[tile_cfg].get_kr();
  const size_t sr = ukernels_[tile_cfg].get_sr();

  return kai_get_rhs_packed_size_rhs_pack_nxk_qai4c32p_qau4c32s0s1_f32_f32_f32_neon(N, K, nr, kr,
                                                                                    32);
}

void KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::quant_nxk_qai4c32_f32(size_t n, size_t k, size_t bl,
                                                                    const float* rhs_f32,
                                                                    uint8_t* rhs_qai4c32,
                                                                    float* rhs_zeros_fp32,
...
void KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::quant_pack_rhs_offline(
    uint8_t* __restrict__ packed_weight, const float* __restrict__ rhs,
    const float* __restrict__ bias, int K, int N,
  ...
  quant_nxk_qai4c32_f32(N, K, 32, rhs, rhs_qai4c32, (float*)rhs_zeros_fp32,
                        (float*)rhs_scales_fp32);
  ...
  // Use kai to pack
  kai_run_rhs_pack_nxk_qai4c32p_qau4c32s0s1_f32_f32_f32_neon(1, N, K, nr, kr, sr, 32, rhs_qai4c32,
                                                             rhs_zeros_fp32, bias, rhs_scales_fp32,
                                                             packed_weight, 0, &params);
...
void KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::matmul(
    float16_t* __restrict__ dst, const float* __restrict__ lhs_fp32,
  ...
  kai_run_lhs_quant_pack_qsi8d32pscalef32_f32_neon(M, K, 32, mr, kr, sr, 0, lhs_fp32,
  ...
  // matmul
  {
    ...
    MLLM_PARALLEL_FOR_WO_CHUNK(i_m_step, 0, M, m_step) {
      for (int i_n_step = 0; i_n_step < N; i_n_step += n_step) {
        ...
        const void* lhs_ptr =
            (const void*)((const char*)workspace
                          + (ukernels_[tile_cfg].get_lhs_packed_offset(i_m_step, K, 32)));
        const void* rhs_ptr =
            (const void*)((const char*)packed_weight_bias
                          + (ukernels_[tile_cfg].get_rhs_packed_offset(i_n_step, K, 32)));
        float16_t* dst_ptr =
            (float16_t*)((uint8_t*)dst
                         + (ukernels_[tile_cfg].get_dst_offset(i_m_step, i_n_step, dst_stride)));
...
void KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::matmul(
    float16_t* __restrict__ dst, const float16_t* __restrict__ lhs_fp16,
    const uint8_t* packed_weight_bias, void* workspace, int M, int K, int N,
    KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::Tiles tile_cfg) {
  const size_t nr = ukernels_[tile_cfg].get_nr();
  const size_t kr = ukernels_[tile_cfg].get_kr();
  ...
  // FIXME:
  // Using m_idx_start ? Fuse this packing to run_matmul loops with m_idx_start.
  kai_run_lhs_quant_pack_qsi8d32pscalef32_f16_neon(M, K, 32, mr, kr, sr, 0, lhs_fp16,
                                                   K * sizeof(float16_t), workspace);
...
std::unordered_map<KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::Tiles,
    ...
    KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::ukernels_ = {
        {KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::Tiles::qsi8d32p1x8_qai4c32p4x8_1x4,
         {.get_m_step = kai_get_m_step_matmul_clamp_f16_qsi8d32p1x8_qai4c32p4x8_1x4_neon_dotprod,
          ...
          .get_lhs_packed_offset =
              kai_get_lhs_packed_offset_matmul_clamp_f16_qsi8d32p1x8_qai4c32p4x8_1x4_neon_dotprod,
          .get_rhs_packed_offset =
              kai_get_rhs_packed_offset_matmul_clamp_f16_qsi8d32p1x8_qai4c32p4x8_1x4_neon_dotprod,
          .get_dst_offset =
              kai_get_dst_offset_matmul_clamp_f16_qsi8d32p1x8_qai4c32p4x8_1x4_neon_dotprod,
          .get_dst_size =
              kai_get_dst_size_matmul_clamp_f16_qsi8d32p1x8_qai4c32p4x8_1x4_neon_dotprod,
        ...
        {KaiLinear_f16_qsi8d32p_qai4c32p_mxk_nxk::Tiles::qsi8d32p4x8_qai4c32p4x8_8x4_i8mm,
         {.get_m_step = kai_get_m_step_matmul_clamp_f16_qsi8d32p4x8_qai4c32p4x8_8x4_neon_i8mm,
          ...
          .get_lhs_packed_offset =
              kai_get_lhs_packed_offset_matmul_clamp_f16_qsi8d32p4x8_qai4c32p4x8_8x4_neon_i8mm,
          .get_rhs_packed_offset =
              kai_get_rhs_packed_offset_matmul_clamp_f16_qsi8d32p4x8_qai4c32p4x8_8x4_neon_i8mm,
          .get_dst_offset =
              kai_get_dst_offset_matmul_clamp_f16_qsi8d32p4x8_qai4c32p4x8_8x4_neon_i8mm,
