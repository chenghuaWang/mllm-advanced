// Auto generated: 2025-07-14 06:36:42
...
#define RTTI_RK_OP_LINALGIROP_FLASHATTENTION2OP_IMPL(v)       \
  return (v)->getKind() >= RK_Op_LinalgIROp_FlashAttention2Op \
         && (v)->getKind() <= RK_Op_LinalgIROp_FlashAttention2Op
...
#define RTTI_RK_OP_LINALGIROP_MULTIMODALROPEOP_IMPL(v)       \
  return (v)->getKind() >= RK_Op_LinalgIROp_MultimodalRoPEOp \
         && (v)->getKind() <= RK_Op_LinalgIROp_MultimodalRoPEOp

#define RTTI_RK_OP_LINALGIROP_VISIONROPEOP_IMPL(v)       \
  return (v)->getKind() >= RK_Op_LinalgIROp_VisionRoPEOp \
         && (v)->getKind() <= RK_Op_LinalgIROp_VisionRoPEOp

#define RTTI_RK_OP_LINALGIROP_QUICKGELUOP_IMPL(v)       \
  return (v)->getKind() >= RK_Op_LinalgIROp_QuickGELUOp \
         && (v)->getKind() <= RK_Op_LinalgIROp_QuickGELUOp
...
#define RTTI_RK_ATTR_BUILTINIRATTR_BOOLATTR_IMPL(v)       \
  return (v)->getKind() >= RK_Attr_BuiltinIRAttr_BoolAttr \
         && (v)->getKind() <= RK_Attr_BuiltinIRAttr_BoolAttr
